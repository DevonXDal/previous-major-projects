...
--------
A secrets.json needs to be placed in this directory in order to load the project. It includes the DefaultConnection database connection string.
This is configured to use MariaDB