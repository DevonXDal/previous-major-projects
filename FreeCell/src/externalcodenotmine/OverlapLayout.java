 ...
 *  over the components.
 *
 *  THIS CODE IS FROM AN EXTERNAL SOURCE AND WAS ONLY ALTERED SLIGHTLY TO BE COMPATIBLE WITH THE PROJECT
 *  THIS CODE IS FROM ROB CAMICK AT: https://tips4java.wordpress.com/2009/07/26/overlap-layout/
 */
