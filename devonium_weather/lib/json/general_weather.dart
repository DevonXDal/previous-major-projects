//-----https://javiercbk.github.io/json_to_dart/----- <--- Code Generated from Here
...
class GeneralWeather {
  ...
  GeneralWeather({this.lat, this.lon, this.timezone, this.timezoneOffset, this.current, this.minutely, this.hourly, this.daily});

  GeneralWeather.fromJson(Map<String, dynamic> json) {
    lat = json['lat'];
    lon = json['lon'];
...
class Current {
  ...
  Current(
      {this.dt, this.sunrise, this.sunset, this.temp, this.feelsLike, this.pressure, this.humidity, this.dewPoint, this.uvi, this.clouds, this.visibility, this.windSpeed, this.windDeg, this.weather});
